...
describe('D3 HierarchyMindMap - Interaction & Animation', () => {
  ...
  describe('Click Expand/Collapse', () => {
    ...
    it.skip('maintains correct CSS classes on expand/collapse', () => {
      const { container } = render(
        <HierarchyMindMap
          data={testData}
          width={800}
  ...
  describe('Zoom and Pan Operations', () => {
    it.skip('supports mouse wheel zoom', () => {
      const { container } = render(
        <HierarchyMindMap
          data={testData}
          width={800}
