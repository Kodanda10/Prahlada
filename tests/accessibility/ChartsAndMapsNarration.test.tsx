...
describe('Accessibility (A11y)', () => {
  it('HierarchyMindMap has accessible content', () => {
    const mockData: any = { id: 'root', label: 'Root', level: 1, visits: 10, children: [] };
    render(<HierarchyMindMap data={mockData} width={500} height={500} />);
    ...
    expect(screen.getByText(/पदानुक्रम दृश्य/i)).toBeInTheDocument();
  });
