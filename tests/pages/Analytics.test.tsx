...
describe('Analytics Page', () => {
  ...
  it('renders the analytics dashboard sections', async () => {
    ...
    expect(await screen.findByText(/इवेंट प्रकार विश्लेषण/i)).toBeInTheDocument();
  ...
  it('renders filter dropdowns', async () => {
    ...
    expect(await screen.findByText(/सभी स्थान/i)).toBeInTheDocument();
  ...
  it('renders visualization components', async () => {
    ...
    expect(await screen.findByTestId('mapbox-visual')).toBeInTheDocument();
  });
});
