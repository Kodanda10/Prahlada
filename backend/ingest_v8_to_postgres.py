...
Run via: docker-compose exec backend python backend/ingest_v8_to_postgres.py
"""
...
DATABASE_URL = os.getenv(
    "DATABASE_URL", 
    "postgresql+asyncpg://dhruv:dhruv123@postgres:5432/dhruv_db"
)
...
async def ingest():
    ...
    data_file = "/app/data/parsed_tweets_v8.jsonl"
