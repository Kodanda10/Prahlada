...
import { HierarchyNode } from '../components/analytics/HierarchyMindMap'; // Import HierarchyNode
...
export const getTweetStats = () => {
    const tweets = loadRealTweets();
...
export const getTweetTimeStats = () => {
    const tweets = loadRealTweets();
...
export const getHierarchyData = (): HierarchyNode => {
    const tweets = loadRealTweets();
