              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-2">
                  <div className="flex gap-2 items-center mb-2 md:mb-0">
                    <span className="px-2 py-1 bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 text-xs rounded-full font-hindi">
                ...
                <h3 className="text-lg text-slate-200 font-medium mb-2 font-hindi">{event.text || event.raw_text}</h3>
                <div className="flex flex-wrap gap-4 text-sm text-slate-500">
                  <div className="flex items-center gap-1 font-hindi">
                    <span className="w-1.5 h-1.5 bg-red-400 rounded-full"></span>
                    {event.parsed_data_v8.location.canonical || "Unknown"}
                  </div>
                  {event.parsed_data_v8.schemes_mentioned.length > 0 && (
                    <div className="flex items-center gap-1 font-hindi">
                      <span className="w-1.5 h-1.5 bg-purple-400 rounded-full"></span>
                      {event.parsed_data_v8.schemes_mentioned.join(', ')}
                    </div>
                  )}
                </div>
              </div>
